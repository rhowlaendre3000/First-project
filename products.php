...
<div class="wrapper container" style="border:3px solid lavender;  background-color: lavender;">
	<form method="post" action="productlog.php" enctype="multipart/form-data">
				<div class="form-group">
						    ...
						    <label for="examples">User Name:</label>
						    <input type="name" name="name" class="form-control"   placeholder="Contact Information" required >		   
				</div>

				<div class="form-group">

						    <label for="examples">Contact Information:</label>
						    <input type="number" name="contact" class="form-control"   placeholder="Contact Information" required >		   
				</div>
				...
				<div class="form-group">
						    ...
						    <label for="examples">Product Image with  </label>
				...
				<div class="form-group">
				      ...
				      <textarea  type="name" class="form-control" rows="5" name="proddesc" id="Product Description"></textarea>
              </div>
			 						...
			 						<div class="col-sm-4">
									  ...
									  <div class="col-sm-4">
									    <div class="text-center">
									      <button type="submit" class="btn btn-primary btn-block" name="upload" id="singlebutton"> UPLOAD</button>
									    </div>
									  </div>
									  <div class="col-sm-4">
			 						</div>
