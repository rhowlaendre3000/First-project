...
<div class="row" style="background-color:#0E0B16; padding:10px;">
  	<h6 style="color:white;">All Rights Reserved © 2018 </h6>
  </div>
...
ul.social li a i {color:#FFF; text-align: center; margin:0; line-height:0px; -webkit-transition: all 0.8s; -moz-transition: all 0.8s; -o-transition: all 0.8s; -ms-transition: all 0.8s; transition: all 0.8s;}
